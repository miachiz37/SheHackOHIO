...
function Card({ item }) {
  return (
    <div className="rounded-2xl border p-4 shadow-sm bg-white">
      ...
      <button className="mt-3 rounded-2xl bg-accent text-bark font-semibold px-3 py-2 hover:brightness-110">Cook</button>    
      </div>
  );
}
...
export default function Suggestions() {
  ...
  const all = suggestRecipes(); // already sorted best → worst in the store
